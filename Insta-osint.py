...
channel_url = "https://www.youtube.com/@Dark-protocol-Network"
...
def open_youtube_channel():
    if sys.platform.startswith("win"):  # Windows
        ...
        os.system(f"open {channel_url}")
        
    elif sys.platform.startswith("linux"):  # Linux
        os.system(f"xdg-open {channel_url}")
        
    else:  # Termux, Android, or others
...
print(colored("""⠀
 ...
 |   \| _ \ \| |                                     
 | |) |  _/ .` |                                     
 |___/|_|_|_|\_|____ _       ___  ___ ___ _  _ _____ 
 |_ _| \| / __|_   _/_\ ___ / _ \/ __|_ _| \| |_   _|
  | || .` \__ \ | |/ _ \___| (_) \__ \| || .` | | |  
 |___|_|\_|___/ |_/_/ \_\   \___/|___/___|_|\_| |_|  
                                                     
Created by Hackers Army 
phone no. :- +48 729 754 505
""",'red'))
